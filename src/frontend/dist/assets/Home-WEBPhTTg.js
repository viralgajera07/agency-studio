import { c as createLucideIcon, j as jsxRuntimeExports, L as Link, B as Button, S as SERVICES, W as WHY_CHOOSE_US, P as PORTFOLIO_ITEMS, a as PROCESS_STEPS, T as TESTIMONIALS, Z as Zap } from "./index-cdHKX1FX.js";
import { B as Badge } from "./badge-BVWNPwr0.js";
import { R as Rocket, C as Card, a as CardContent, S as Star } from "./card-jjXv-ZwK.js";
import { m as motion } from "./proxy-B8Wf2Yrr.js";
import { T as TrendingUp, A as ArrowRight, a as Target } from "./trending-up-DwSXwnvx.js";
/**
...
const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function ServiceCard({ service, index }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.article,
    {
      ...
      className: "group",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "h-full bg-card border-border shadow-card hover:shadow-elevated hover:border-primary/40 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl gradient-primary flex items-center justify-center shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-6 h-6 text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg text-foreground mb-2", children: service.title }),
...
function WhyCard({ item, index }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 shrink-0 rounded-lg bg-primary/15 border border-primary/25 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function PortfolioCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.article,
    {
      ...
      className: "group",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "overflow-hidden bg-card border-border shadow-card hover:shadow-elevated hover:border-primary/30 transition-smooth", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 w-16 h-16 rounded-2xl gradient-primary flex items-center justify-center shadow-elevated mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-7 h-7 text-primary-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-2 -right-2 w-6 h-6 rounded-full bg-background border border-primary text-primary text-xs font-bold font-display flex items-center justify-center", children: step.step })
        ] }),
...
function TestimonialCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.article,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "h-full bg-card border-border shadow-card hover:shadow-elevated hover:border-primary/25 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1", children: Array.from(
          { length: testimonial.rating },
          (_, i) => `star-${i}`
        ).map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-primary text-primary" }, key)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "w-6 h-6 text-primary/40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground text-sm leading-relaxed flex-1 italic", children: [
          "“",
          testimonial.content,
          "”"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-2 border-t border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full gradient-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground text-sm font-display font-bold", children: initials }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm truncate", children: testimonial.name }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.h1,
              {
                ...
                children: [
                  "Elevate Your",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Digital Presence" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: HERO_SERVICES.map((svc, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    initial: { opacity: 0, y: 16 },
                    animate: { opacity: 1, y: 0 },
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(svc.icon, { className: `w-4 h-4 ${svc.iconColor}` })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm leading-tight mb-0.5", children: svc.label }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "text-center mb-14",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 border border-accent/40 bg-accent/10 text-accent font-medium px-3 py-1", children: "Client Stories" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "h2",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "Real results, real people — here's what our clients experience working with us." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: TESTIMONIALS.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TestimonialCard, { testimonial: t, index: i }, t.id))
            }
          )
        ] })
      }
